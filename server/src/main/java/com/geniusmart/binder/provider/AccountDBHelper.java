package com.geniusmart.binder.provider;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;
import android.database.sqlite.SQLiteOpenHelper;

import com.geniusmart.binder.ServerApplication;
...
public class AccountDBHelper extends SQLiteOpenHelper {
    ...
    public static AccountDBHelper getInstance() {
        if (null == mAccountDBHelper) {
            mAccountDBHelper = new AccountDBHelper(ServerApplication.getInstance(), AccountDBHelper.DB_NAME, null, AccountDBHelper.DB_VERSION);
        }
